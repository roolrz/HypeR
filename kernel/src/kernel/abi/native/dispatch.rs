...
use hyper::abi::native::{
    ...
    HYPER_NATIVE_SYS_SYSTEM_CONFIG, HYPER_NATIVE_SYS_TASK_GROUP_CREATE,
...
use super::handlers::{
    ...
    sys_resource_domain_create, sys_system_config, sys_task_group_create,
    ...
    sys_task_inspector_scan_threads, sys_thread_create, sys_thread_exit, sys_thread_request_stop,
    sys_thread_sleep, sys_thread_start, sys_thread_yield, sys_virtual_cpu_get_info,
...
define_immediate_routes! {
    HYPER_NATIVE_SYS_SYSTEM_CONFIG => sys_system_config,
