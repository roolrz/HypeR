...
impl GuestSyncExit {
    ...
    pub const fn legacy_console_byte(self) -> Option<u8> {
        match self {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct UnsupportedGuestExit {
    pub(crate) cause: u64,
...
impl GuestSyncAction {
    ...
    pub const fn complete_legacy_console() -> Self {
