...
mkdir -p "$fixture/hal/src/arch/aarch64" "$fixture/hal/src/arch/riscv64" "$fixture/hal/src/arch/x86_64"

restore_fixture() {
    cp "$root/hal/src/arch/aarch64/context.S" "$fixture/hal/src/arch/aarch64/context.S"
    cp "$root/hal/src/arch/riscv64/context.S" "$fixture/hal/src/arch/riscv64/context.S"
    cp "$root/hal/src/arch/x86_64/context.S" "$fixture/hal/src/arch/x86_64/context.S"
}
