...
pub struct FileInfo { pub size: u64, pub mode: u32, pub kind: u32 }
#[repr(C)]
#[derive(Clone, Copy)]
pub struct DirectoryEntry { pub size: u64, pub mode: u32, pub kind: u32, pub name_length: u32, pub reserved: u32, pub name: [u8; 256] }
impl DirectoryEntry { pub const EMPTY: Self = Self { size: 0, mode: 0, kind: 0, name_length: 0, reserved: 0, name: [0; 256] }; }
#[link(name = "hyper-std", kind = "static")]
unsafe extern "C" {
    pub fn __hyper_std_fs_open(path: *const u8, size: usize, options: u32, handle: *mut u64) -> i64;
    pub fn __hyper_std_fs_close(handle: u64);
    pub fn __hyper_std_fs_read(handle: u64, offset: u64, buffer: *mut u8, size: usize, actual: *mut usize) -> i64;
    pub fn __hyper_std_fs_write(handle: u64, offset: u64, append: u32, buffer: *const u8, size: usize, actual: *mut usize, end: *mut u64) -> i64;
    ...
    pub fn __hyper_std_fs_stat(path: *const u8, size: usize, info: *mut FileInfo) -> i64;
    pub fn __hyper_std_fs_readdir(handle: u64, cookie: u64, entries: *mut DirectoryEntry, count: *mut usize, next: *mut u64) -> i64;
...
#[link(name = "hyper-std", kind = "static")]
unsafe extern "C" {
    pub fn __hyper_std_process_begin(program: *const u8, size: usize, cwd: *const u8, cwd_size: usize, builder: *mut u64) -> i64;
    pub fn __hyper_std_process_argument(builder: u64, bytes: *const u8, size: usize, environment: u32) -> i64;
    pub fn __hyper_std_process_pipe(builder: u64, stream: u32, parent: *mut u64) -> i64;
    pub fn __hyper_std_process_inherit(builder: u64, stream: u32, source: u64, parent_stream: u32) -> i64;
    ...
    pub fn __hyper_std_process_wait(process: u64, block: u32, done: *mut u32, reason: *mut u32, code: *mut i64) -> i64;
    pub fn __hyper_std_pipe_create(first: *mut u64, second: *mut u64) -> i64;
    pub fn __hyper_std_pipe_try_read(handle: u64, buffer: *mut u8, capacity: usize, actual: *mut usize) -> i64;
    pub fn __hyper_std_pipe_read(handle: u64, buffer: *mut u8, capacity: usize, actual: *mut usize) -> i64;
    pub fn __hyper_std_pipe_write(handle: u64, buffer: *const u8, size: usize, actual: *mut usize) -> i64;
    pub fn __hyper_std_wait_pair(first: u64, second: u64, set: *mut u64, first_id: *mut u64, second_id: *mut u64) -> i64;
