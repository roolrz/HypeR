...
pub const CONSTANTS: &[AbiConstant] = &[
    AbiConstant {
        name: "vmar_allocate_exact",
        value: 1,
    },
    AbiConstant {
        name: "system_config_application_address_limit",
        value: 2,
    },
    AbiConstant {
        name: "system_config_page_size",
        value: 1,
    },
    AbiConstant {
...
const VMAR_ALLOCATE_ARGUMENTS: &[Argument] = &[
    ...
    scalar_argument("options", ValueKind::U64),
];
const VMAR_ALLOCATE_RESULTS: &[ResultValue] = &[
    ResultValue {
        name: "child",
        kind: ValueKind::Handle,
        handle: Some(ProducedHandle {
...
pub const SYSCALLS: &[Syscall] = &[
    ...
    Syscall {
        ...
        name: "system_config",
        feature: FeatureGate::Core,
        arguments: &[scalar_argument("key", ValueKind::U64)],
        results: &[ResultValue {
            name: "value",
            kind: ValueKind::U64,
            handle: None,
