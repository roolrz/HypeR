...
| `native_block_memory_bytes` | `1048576` |
| `native_block_queue_count` | `6` |
...
| `auxv_initial_stack_base` | `1213792259` |
| `auxv_initial_stack_capacity` | `1213792260` |
| `auxv_initial_stack_size` | `1213792261` |
| `startup_handle_purpose_initial_stack_vmar` | `15` |
...
| `virtual_platform_aarch64_reference_max_vcpus` | `8` |
| `virtual_machine_power_cpu_on` | `1` |
| `virtual_machine_power_cpu_off` | `2` |
| `virtual_machine_power_system_off` | `3` |
| `virtual_machine_power_system_reset` | `4` |
...
| `vcpu_host_cpu_unknown` | `4294967295` |
...
- Native startup supplies kernel-minted ROOT_VMAR and INITIAL_STACK_VMAR handles; process builders may not replace either purpose. Initial-stack auxiliary values carry the reserved VMAR base (including its lower guard), usable capacity, and initially mapped size in bytes. The stack top is base + page_size + capacity; only [top - size, top) is initially mapped read-write, with a page left unmapped at both ends of the reservation. The remaining capacity is reserved virtual space, not committed RAM. The runtime may explicitly map additional backing downward within this VMAR while preserving the fixed top and guards; faults do not implicitly grow stacks. The initial size follows the ELF stack request or loader default. Closing the VMAR handle does not unmap or destroy its address-space-owned reservation.
...
| 17 | `directory_open_file` | `directory: handle`, `path: user_address`, `path_size: byte_count`, `requested_rights: rights`, `options: u32` | `file: handle` | `directory: Borrow, kind=directory, rights=0x10`, `file: produce, kind=file, exact-from(requested_rights), allowed=0x1800000bb, required-from=directory` | `path: Read, len=path_size bytes, max-bytes=4096; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 18 | `file_read_at` | `file: handle`, `options: u32`, `offset: u64`, `output: user_address`, `output_capacity: byte_count` | `actual_bytes: byte_count`, `file_size: byte_count` | `file: Borrow, kind=file, rights=0x10` | `output: Write, len=output_capacity bytes, max-bytes=2097152; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
...
| 44 | `directory_open_directory` | `directory: handle`, `path: user_address`, `path_size: byte_count`, `requested_rights: rights`, `options: u32` | `child: handle` | `directory: Borrow, kind=directory, rights=0x10`, `child: produce, kind=directory, exact-from(requested_rights), allowed=0x1800000bb, required-from=directory` | `path: Read, len=path_size bytes, max-bytes=4096; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
...
| 46 | `file_create_executable_vmo` | `file: handle` | `vmo: handle`, `byte_size: byte_count` | `file: Borrow, kind=file, rights=0x90`, `vmo: produce, kind=vmo, fixed=0xdb` | — | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=None` | `Capability` |
...
| 77 | `thread_create` | `entry: u64`, `stack: u64`, `tls: u64`, `argument: u64`, `affinity_words: user_address`, `word_count: element_count` | `thread: handle` | `thread: produce, kind=thread, fixed=0xc0d` | `affinity_words: Read, len=word_count elements, max-elements=4, element-size=8; order=0` | `blocking=Never, cancellation=None, restart=Never, completion=Returns, flags=None` | `Task` |
...
| 83 | `file_write_at` | `file: handle`, `options: u32`, `offset: u64`, `input: user_address`, `input_size: byte_count` | `actual_bytes: byte_count`, `end_offset: u64` | `file: Borrow, kind=file, rights=0x20` | `input: Read, len=input_size bytes, max-bytes=2097152; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
...
| 95 | `directory_scope_create` | `root: handle`, `start: handle`, `rights: rights` | `directory: handle` | `root: Borrow, kind=directory, rights=0x10`, `start: Borrow, kind=directory, rights=0x10`, `directory: produce, kind=directory, exact-from(rights), allowed=0x1800000bb, required-from=root` | — | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 96 | `directory_get_metadata` | `directory: handle`, `path: user_address`, `path_length: byte_count`, `options: u32`, `output: user_address`, `output_size: byte_count` | `supported_size: byte_count` | `directory: Borrow, kind=directory, rights=0x18` | `path: Read, len=path_length bytes, max-bytes=4096; order=0`, `output: Write, len=output_size bytes, max-bytes=4096, record=file_metadata; order=1` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 97 | `file_get_metadata` | `file: handle`, `output: user_address`, `output_size: byte_count` | `supported_size: byte_count` | `file: Borrow, kind=file, rights=0x8` | `output: Write, len=output_size bytes, max-bytes=4096, record=file_metadata; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 98 | `directory_get_self_metadata` | `directory: handle`, `output: user_address`, `output_size: byte_count` | `supported_size: byte_count` | `directory: Borrow, kind=directory, rights=0x8` | `output: Write, len=output_size bytes, max-bytes=4096, record=file_metadata; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 99 | `directory_set_metadata` | `directory: handle`, `path: user_address`, `path_length: byte_count`, `options: u32`, `input: user_address`, `input_size: byte_count` | — | `directory: Borrow, kind=directory, rights=0x80000010` | `path: Read, len=path_length bytes, max-bytes=4096; order=1`, `input: Read, len=input_size bytes, max-bytes=4096, record=file_metadata_update; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 100 | `file_set_metadata` | `file: handle`, `input: user_address`, `input_size: byte_count` | — | `file: Borrow, kind=file, rights=0x80000000` | `input: Read, len=input_size bytes, max-bytes=4096, record=file_metadata_update; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 101 | `directory_rename` | `source: handle`, `path: user_address`, `path_length: byte_count`, `destination: handle`, `new_path: user_address`, `new_path_length: byte_count` | — | `source: Borrow, kind=directory, rights=0x30`, `destination: Borrow, kind=directory, rights=0x30` | `path: Read, len=path_length bytes, max-bytes=4096; order=0`, `new_path: Read, len=new_path_length bytes, max-bytes=4096; order=1` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 102 | `directory_link` | `source: handle`, `path: user_address`, `path_length: byte_count`, `destination: handle`, `new_path: user_address`, `new_path_length: byte_count` | — | `source: Borrow, kind=directory, rights=0x30`, `destination: Borrow, kind=directory, rights=0x30` | `path: Read, len=path_length bytes, max-bytes=4096; order=0`, `new_path: Read, len=new_path_length bytes, max-bytes=4096; order=1` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 103 | `directory_symlink` | `directory: handle`, `path: user_address`, `path_length: byte_count`, `target: user_address`, `target_length: byte_count` | — | `directory: Borrow, kind=directory, rights=0x30` | `path: Read, len=path_length bytes, max-bytes=4096; order=0`, `target: Read, len=target_length bytes, max-bytes=4096; order=1` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 104 | `directory_read_link` | `directory: handle`, `path: user_address`, `path_length: byte_count`, `output: user_address`, `capacity: byte_count` | `actual: byte_count` | `directory: Borrow, kind=directory, rights=0x10` | `path: Read, len=path_length bytes, max-bytes=4096; order=0`, `output: Write, len=capacity bytes, max-bytes=4096; order=1` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 105 | `directory_canonicalize` | `directory: handle`, `path: user_address`, `path_length: byte_count`, `output: user_address`, `capacity: byte_count` | `actual: byte_count` | `directory: Borrow, kind=directory, rights=0x10` | `path: Read, len=path_length bytes, max-bytes=4096; order=0`, `output: Write, len=capacity bytes, max-bytes=4096; order=1` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 106 | `directory_remove_if` | `directory: handle`, `path: user_address`, `path_length: byte_count`, `options: u32`, `expected_node_id: u64` | — | `directory: Borrow, kind=directory, rights=0x30` | `path: Read, len=path_length bytes, max-bytes=4096; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 107 | `directory_open_directory_nofollow` | `directory: handle`, `path: user_address`, `path_length: byte_count`, `rights: rights` | `directory: handle` | `directory: Borrow, kind=directory, rights=0x10`, `directory: produce, kind=directory, exact-from(rights), allowed=0x1800000bb, required-from=directory` | `path: Read, len=path_length bytes, max-bytes=4096; order=0` | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 108 | `file_sync` | `file: handle`, `scope: u32` | — | `file: Borrow, kind=file, rights=0x20` | — | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
| 109 | `file_lock` | `file: handle`, `mode: u32`, `deadline: u64` | — | `file: Borrow, kind=file, rights=0x100000000` | — | `blocking=MayBlock, cancellation=Explicit, restart=Never, completion=Returns, flags=Strict` | `Capability` |
...
| 114 | `vmo_create_snapshot` | `vmo: handle` | `vmo: handle`, `byte_size: byte_count` | `vmo: Borrow, kind=vmo, rights=0x10`, `vmo: produce, kind=vmo, fixed=0x5b` | — | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=None` | `Capability` |
| 115 | `file_create_snapshot` | `file: handle` | `vmo: handle`, `byte_size: byte_count` | `file: Borrow, kind=file, rights=0x10`, `vmo: produce, kind=vmo, fixed=0x5b` | — | `blocking=MayBlock, cancellation=None, restart=Never, completion=Returns, flags=None` | `Capability` |
...
| `virtual_machine_power_request` | 40 | 40 | 8 | `id: u64 @ 0`, `vcpu: u32 @ 8`, `operation: u32 @ 12`, `target: u32 @ 16`, `reserved: u32 @ 20`, `entry: u64 @ 24`, `context: u64 @ 32` |
| `virtual_machine_info` | 32 | 40 | 8 | `phase: u32 @ 0`, `vcpu_count: u32 @ 4`, `guest_physical_base: u64 @ 8`, `memory_size: u64 @ 16`, `architecture: u32 @ 24`, `platform_profile: u32 @ 28`, `resident_memory_bytes: u64 @ 32` |
| `virtual_cpu_info` | 24 | 32 | 8 | `vcpu_id: u32 @ 0`, `phase: u32 @ 4`, `scheduler_thread_id: u64 @ 8`, `terminal_reason: u32 @ 16`, `reserved: u32 @ 20`, `host_cpu: u32 @ 24`, `migration_target: u32 @ 28` |
