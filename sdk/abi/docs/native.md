...
| Name | Value |
| --- | ---: |
| `vmar_allocate_exact` | `1` |
| `system_config_application_address_limit` | `2` |
| `system_config_page_size` | `1` |
...
| `auxv_main_stack_size` | `1213792262` |
...
| 49 | `vmar_allocate` | `vmar: handle`, `address: u64`, `size: byte_count`, `options: u64` | `child: handle`, `address: u64` | `vmar: Borrow, kind=vmar, rights=0x40`, `child: produce, kind=vmar, fixed=0x4b` | — | `blocking=Never, cancellation=None, restart=Never, completion=Returns, flags=Strict` | `Capability` |
