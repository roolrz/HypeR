...
pub const fn hyper_native_object_transfer_class(object_kind: u32) -> u32 {
    match object_kind {
        ...
        HYPER_NATIVE_OBJECT_VIRTUAL_SERIAL => HYPER_NATIVE_TRANSFER_CLASS_GENERAL,
...
pub const HYPER_NATIVE_SIGNAL_VIRTUAL_SERIAL_DISCONNECTED: u64 = 1_u64 << 2;
...
pub const HYPER_NATIVE_SYS_VIRTUAL_SERIAL_READ: u64 = 75;
