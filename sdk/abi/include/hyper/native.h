...
static inline uint32_t hyper_native_object_transfer_class(uint32_t object_kind) {
    switch (object_kind) {
        ...
        case HYPER_NATIVE_OBJECT_VIRTUAL_SERIAL: return HYPER_NATIVE_TRANSFER_CLASS_GENERAL;
...
#define HYPER_NATIVE_SIGNAL_VIRTUAL_SERIAL_DISCONNECTED (UINT64_C(1) << 2)
...
#define HYPER_NATIVE_SYS_VIRTUAL_SERIAL_READ UINT64_C(75)
